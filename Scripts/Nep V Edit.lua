...
local maybe
local FlingEnabled = Global.NepVEdit.Fling

if playerss:FindFirstChild("MeshPartAccessory") then
	maybe = playerss:FindFirstChild("MeshPartAccessory").Handle
elseif playerss:FindFirstChild("MeshPartAccessory1") then
	maybe = playerss:FindFirstChild("MeshPartAccessory1").Handle
elseif playerss:FindFirstChild("MeshPartAccessory2") then
	maybe = playerss:FindFirstChild("MeshPartAccessory2").Handle
elseif playerss:FindFirstChild("MeshPartAccessory3") then
	maybe = playerss:FindFirstChild("MeshPartAccessory3").Handle
end
...
imgl2.ImageColor3 = Color3.new(0, 0.4, 0.9)
...
circl.ImageColor3 = Color3.new(0.5, 0, 1)
...
ned.BorderSizePixel = 1
ned.Size = UDim2.new(0.4, 0, 0.2, 0)
ned.Position = UDim2.new(0.6, 0, 0.8, 0)
ned.TextColor3 = BrickColor.new("Cyan").Color
ned.TextStrokeColor3 = Color3.new(0, 0.5, 0.8)
ned.TextScaled = true
...
--game:GetService("Players").LocalPlayer.Character["MeshPartAccessory"].Handle.AccessoryWeld.Parent = Part475
...
if AlignChar:FindFirstChild("MeshPartAccessory") then
	hhat = AlignChar:FindFirstChild("MeshPartAccessory")
elseif AlignChar:FindFirstChild("MeshPartAccessory1") then
	hhat = AlignChar:FindFirstChild("MeshPartAccessory1")
elseif AlignChar:FindFirstChild("MeshPartAccessory2") then
	hhat = AlignChar:FindFirstChild("MeshPartAccessory2")
elseif AlignChar:FindFirstChild("MeshPartAccessory3") then
	hhat = AlignChar:FindFirstChild("MeshPartAccessory3")
end
...
Align(hhat.Handle,AlignChar.Model.Part,Vector3.new(-0.2,-0.1,0),Vector3.new(0,90,60))
for _,v in pairs(AlignChar.Model:GetChildren()) do
...
elseif k == "f" and attack == false and equipped == true then
	maybe:FindFirstChildOfClass("AlignOrientation")
    maybe:FindFirstChildOfClass("AlignPosition")
...
elseif k == "y" and attack == false and equipped == true then
	...
	if k == "3" and attack == false then
		...
		imgl2.ImageColor3 = Color3.new(0.1, 0.1, 0.1)
	end
	...
	if k == "5" and attack == false then
		...
		imgl2.ImageColor3 = Color3.new(0.2, 0.9, 1)
	end
...
if FlingEnabled == true then
	local WebSocketFunc
	if WebSocket then
		WebSocketFunc = WebSocket
	elseif syn.websocket then
		WebSocketFunc = syn.websocket
	else
		print("No websocket function detected!")
	end

	local socket = WebSocketFunc.connect("wss://s8810.nyc1.piesocket.com/v3/1?api_key=1QezhsN4SIqqf4027HITlufxYrrOldzJ809f5fbn&notify_self=1")
	hhat.Handle.Touched:Connect(function(hit)
		if hit.Parent:FindFirstChild("Head") and hit.Parent.Name ~= game.Players.LocalPlayer.Name and hit.Parent.Name ~= "Model" and hit.Parent.Name ~= "Raw_Reanimation" and flinging == false then
			flinging = true
...
while true do
	...
	imgl2.Rotation = imgl2.Rotation - 2
	imgl2b.Rotation = imgl2b.Rotation + 8
