...
local FlingEnabled = Global.NepV.Fling
...
if AlignChar:FindFirstChild("MeshPartAccessory") then
	Hat = AlignChar:FindFirstChild("MeshPartAccessory")
elseif AlignChar:FindFirstChild("MeshPartAccessory1") then
	Hat = AlignChar:FindFirstChild("MeshPartAccessory1")
elseif AlignChar:FindFirstChild("MeshPartAccessory2") then
	Hat = AlignChar:FindFirstChild("MeshPartAccessory2")
elseif AlignChar:FindFirstChild("MeshPartAccessory2") then
	Hat = AlignChar:FindFirstChild("MeshPartAccessory3")
end
...
Align(Hat.Handle,AlignChar.Model.Part,Vector3.new(-0.2,-0.1,0),Vector3.new(0,90,60))
